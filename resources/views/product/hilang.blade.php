...
@section('title', 'Daftar Sepeda Hilang')
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12" style="padding-bottom: 20px">
                    <div class="contact-list">
                        ...
                        <div class="social-st-list">
                            <form action="{{route('product.tidakhilang', $product->id)}}" method="POST">
                                @csrf
                            <button class="btn btn-primary btn-block btn-sm"
                                        onclick="return confirm('Tandai sepeda sebagai kembali?');">Tandai sudah kembali</button>
                                    </form>
                        </div>
                    </div>
                </div>
