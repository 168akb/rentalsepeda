                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="breadcomb-wp">
                                    ...
                                    <div class="breadcomb-ctn">
                                        <h2>List Owner</h2>
                                        <p><strong>{{$data['totalUser']}}</strong> Total jumlah Owner.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <form action="{{ route('users.index') }}" method="get">
                                <div class="row">  
                                    <div class="nk-int-st search-input search-overt col"><input type="text" name="search"
                                            ...
                                            placeholder="Search User..." onblur="this.form.submit()">
                                    <button class="btn search-ib submit">Search</button>
                                    </div>
                                    <br>
                                    <br>
                                    <div class="col"><a href="{{route('users.create')}}"
                                    class="btn btn-success btn-sm float-right btn-block">Tambah User</a></div>
                                </div>
                            </form>
                            <!-- <h2>Basic Table</h2>
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-lg-6 text-right">
                        <a class="btn btn-sm btn-primary" data-trigger="hover" data-toggle="popover" data-placement="right" data-content="Edit Data" href="{{route('users.edit', $p->id)}}"><i class="notika-icon notika-edit"></i></a>
                    </div>
                </div>
